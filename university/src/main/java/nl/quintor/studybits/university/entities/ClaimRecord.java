...
public class ClaimRecord {
     ...
     */
    @AttributeOverrides({@AttributeOverride(name = "message", column = @Column(name = "claimOfferMessage")), @AttributeOverride(name = "did", column = @Column(name = "claimOfferDid"))})
    @Embedded
     ...
     */
    @AttributeOverrides({@AttributeOverride(name = "message", column = @Column(name = "claimMessage")), @AttributeOverride(name = "did", column = @Column(name = "claimDid"))})
    @Embedded
