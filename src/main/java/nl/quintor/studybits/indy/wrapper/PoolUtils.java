...
public class PoolUtils {
    ...
    private static File createGenesisTxnFile(String filename) throws IOException {
        File file = Paths.get(FileUtils.getTempDirectoryPath(), "indy", filename).toFile();
        String testPoolIp = ObjectUtils.firstNonNull(System.getenv("TEST_POOL_IP"), DEFAULT_POOL_IP);
        List<String> defaultTxns = Arrays.asList(
        ...
        FileUtils.writeLines(file, defaultTxns);
