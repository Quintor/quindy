...
public class MessageScenarioIT {
    ...
    public void fullScenarioTest() throws Exception {
        ...
        //ACME requests the scheme from the ledger #? Never used??
        ...
        //Create proof object from available credenties for this proof request and self-attested attributes
        ...
        System.out.println("00000000000000000000000000000000000000: " + decryptedProofRequest);
        //Alice fufills proof request
        //Create proof object from available credentials for this proof request and self-attested attributes
